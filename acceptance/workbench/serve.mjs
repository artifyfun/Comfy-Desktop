// Workbench 验收用静态服务器（前端构建产物 + SPA fallback + stub 注入；stub mock AG-UI SSE 与 workbench REST）
...
// 本目录固定为 <repo>/acceptance/workbench/
...
createServer(async (req, res) => {
  ...
  if (pathname === '/__workbench_stub.js') return serveStub(res)
