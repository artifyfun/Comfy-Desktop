...
// 生成应用接口
app.post('/api/generate-app', async (req: express.Request, res: express.Response) => {
  try {
...
// 修改代码接口
app.post('/api/modify-code', async (req: express.Request, res: express.Response) => {
  try {
    const { prompt, language, api_key, base_url, model } = req.body
...
app.post('/api/market/apps', async (_req, res) => {
  try {
...
// 根据ID获取app
app.post('/api/apps/detail', (req: express.Request, res: express.Response) => {
  try {
    const { id } = req.body
...
// 创建app
app.post('/api/apps/create', (req: express.Request, res: express.Response) => {
  try {
    const { name } = req.body

    if (!name) {
      return res.status(HTTP_STATUS.BAD_REQUEST).json(createErrorResponse('name field is required'))
    }
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(createErrorResponse('Failed to create app'))
  }
})

// 更新app
app.post('/api/apps/update', (req: express.Request, res: express.Response) => {
  try {
    const { id } = req.body
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(createErrorResponse('Failed to update app'))
  }
})

// 删除app
app.post('/api/apps/remove', (req: express.Request, res: express.Response) => {
  try {
    const { id } = req.body
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(createErrorResponse('Failed to delete app'))
  }
})

// 导入apps
app.post('/api/apps/import', (req: express.Request, res: express.Response) => {
  try {
    const { apps } = req.body
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(createErrorResponse('Failed to import apps'))
  }
})
...
app.post('/api/config', (_req, res) => {
  try {
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(createErrorResponse('Failed to get config'))
  }
})
...
app.post('/api/config/update', (req, res) => {
  try {
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(createErrorResponse('Failed to save config'))
  }
})

// 获取应用风格
app.post('/api/build/styles', async (_req, res) => {
  try {
...
app.post('/api/cache/clear', (_req, res) => {
  try {
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(createErrorResponse('Failed to clear cache'))
  }
})
...
app.post('/api/ngrok/url', async (req: express.Request, res: express.Response) => {
  try {
    ...
    res
      .status(HTTP_STATUS.INTERNAL_SERVER_ERROR)
      .json(createErrorResponse('Failed to connect ngrok'))
  }
})
...
// 关机接口
app.post('/api/shutdown', async (req: express.Request, res: express.Response) => {
  try {
