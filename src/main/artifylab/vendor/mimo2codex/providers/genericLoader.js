    ...
    return {
        ...
        features: features
            ? {
                ...
                minimaxCompat: typeof features.minimaxCompat === "boolean" ? features.minimaxCompat : undefined,
                dropNullStrict: typeof features.dropNullStrict === "boolean" ? features.dropNullStrict : undefined,
                dropNullContent: typeof features.dropNullContent === "boolean" ? features.dropNullContent : undefined,
                dropToolChoiceAuto: typeof features.dropToolChoiceAuto === "boolean"
                    ? features.dropToolChoiceAuto
                    : undefined,
                dropStreamOptions: typeof features.dropStreamOptions === "boolean"
                    ? features.dropStreamOptions
                    : undefined,
                dropParallelToolCalls: typeof features.dropParallelToolCalls === "boolean"
                    ? features.dropParallelToolCalls
                    : undefined,
                mergeSystemMessages: typeof features.mergeSystemMessages === "boolean"
                    ? features.mergeSystemMessages
                    : undefined,
                extractThinkTags: typeof features.extractThinkTags === "boolean"
                    ? features.extractThinkTags
                    : undefined,
                dropResponseFormat: typeof features.dropResponseFormat === "boolean"
                    ? features.dropResponseFormat
                    : undefined,
                dropNonFunctionTools: typeof features.dropNonFunctionTools === "boolean"
                    ? features.dropNonFunctionTools
                    : undefined,
                dropReasoningEffort: typeof features.dropReasoningEffort === "boolean"
                ...
                enhanceErrorPreset: features.enhanceErrorPreset === "sensenova" ||
        ...
        forceDefaultModel: typeof obj.forceDefaultModel === "boolean" ? obj.forceDefaultModel : undefined,
    };
}
...
export function writeSpecsToFile(filePath, specs) {
    ...
    const shortcutSeen = new Set([mimo.shortcut, deepseek.shortcut]);
    for (const spec of specs) {
        ...
        if (shortcutSeen.has(shortcut)) {
            throw new GenericLoaderError(`provider shortcut "${shortcut}" (provider "${spec.id}") is already taken — ` +
    ...
    return [
        {
            ...
            forceDefaultModel: env.GENERIC_FORCE_DEFAULT_MODEL === "1" || env.GENERIC_FORCE_DEFAULT_MODEL === "true",
        },
    ];
}
