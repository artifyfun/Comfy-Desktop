...
const translations = {
  zh: {
    ...
    buildModelHint: '用于「构建应用」的 agent 模型，默认 deepseek-v4-flash；底层由 Codex（开源 harness）驱动，可切换 DeepSeek / OpenRouter 等第三方模型',
    saveSettings: '保存设置',
    testConnection: '测试连接',
    testing: '测试中...',
    ...
    queueDetailDescription: '独立的批量队列管理页：完整配置关机/通知，支持删除出队、暂停/继续、置顶与日志查看',
    queueSettings: '队列设置',
  ...
  en: {
    ...
    buildModelHint: 'Agent model for "Build App", default deepseek-v4-flash; driven by Codex (open-source harness), supports DeepSeek / OpenRouter etc.',
    ...
    shutdownAfterRunDesc: 'Shut down the computer after the whole queue finishes naturally (30s delay)',
    ...
    aiEditPlaceholder: 'Describe what to change on the page, e.g. "Switch color scheme to light, make buttons rounded"',
    aiEditTip: 'Describe what you want to change on the page, e.g. "Switch color scheme to light, make buttons rounded"',
    aiEditStop: 'Stop',
    aiEditRunning: 'AI is editing...',
    aiEditSuccess: 'AI edit successful',
    aiEditFailed: 'AI edit failed',
    optimizePrompt: 'Optimize Prompt',
    optimizePromptConfirm: 'AI will optimize the current prompt and overwrite the content. Continue?',
    ...
    manualUpdateAvailable: 'You can also manually check the GitHub releases page for the latest version',
    downloadFromGitHub: 'Download from GitHub',
    checkGitHubReleases: 'View GitHub Releases',
    manualDownload: 'Manual Download',
    confirmManualDownload: 'This will open the GitHub releases page where you can download the latest version. Continue?',
