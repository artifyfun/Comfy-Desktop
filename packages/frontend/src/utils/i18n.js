...
const translations = {
  ...
  en: {
    ...
    canvasComposePrompt: 'Compose the reference images into one new image, merging subjects and style',
    canvasGenNode: 'Generate node',
    canvasGenPromptPh: 'Enter prompt (Cmd/Ctrl+Enter to run)',
    canvasGenRefs: 'Refs',
    canvasGenRun: 'Run',
    canvasGenRunning: 'Running',
    canvasInpaintPrompt: 'Inpaint the reference: keep unmasked areas unchanged, redraw the subject region only',
    canvasOutpaintPrompt: 'Outpaint the reference: extend the scene outward, keep style and lighting consistent',
    canvasEnhancePrompt: 'Upscale the reference image 4x with sharpened details',
    canvasReversePrompt: 'Reverse-engineer the prompt of this image, output a reusable English prompt only',
    ...
    canvasBatchShotsPrompt: 'Generate one image per shot description below, keep character and scene consistent:',
    ...
    workbenchValidating: 'Validating workflow & models…',
