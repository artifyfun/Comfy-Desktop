...
const translations = {
  zh: {
    ...
    workbenchEnvHint: '工作台决策时自动感知以上环境：可联网检索工作流最佳实践与社区提示词模板，并结合本机模型/节点/显存推荐可行设置。',
    workbenchSend: '发送',
  ...
  en: {
    ...
    workbenchEnvHint: 'The agent auto-senses this environment when deciding: it can search the web for workflow best practices & community prompt templates, and recommends feasible settings based on local models/nodes/VRAM.',
    workbenchSend: 'Send',
