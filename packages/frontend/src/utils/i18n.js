...
const translations = {
  zh: {
    ...
    canvasScResize: '选中节点拖四角手柄缩放（图片默认保持比例，Ctrl 自由拉伸）',
  ...
  en: {
    ...
    canvasScResize: 'Select a node and drag its corner handles to resize (images keep aspect ratio, hold Ctrl for free form)',
