...
const translations = {
  zh: {
    ...
    canvasOpenWb: '展开工作台',
    canvasCloseWb: '收起工作台',
    canvasLinkTool: '连线工具：依次点两个物件建立关联',
    canvasLinkPickFirst: '连线：点击第一个物件',
    canvasLinkPickSecond: '连线：再点击另一个物件（Esc 取消）',
  ...
  en: {
    ...
    canvasLinkTool: 'Link tool: click two objects to connect them',
    canvasLinkPickFirst: 'Link: click the first object',
    canvasLinkPickSecond: 'Link: click another object (Esc to cancel)',
