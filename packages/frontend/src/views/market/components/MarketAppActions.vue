<template>
  <div class="mb-8">
    ...
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div class="flex-1 max-w-md">
        <div class="relative">
          ...
          />
          <i
            class="absolute left-4 top-1/2 transform -translate-y-1/2 text-slate-400 fas fa-search"
          ></i>
          <button
            v-if="searchQuery"
    ...
    <div
      ...
      class="p-4 mt-4 rounded-lg border backdrop-blur-sm bg-slate-800/30 border-slate-700"
    >
      <!-- 搜索历史 -->
